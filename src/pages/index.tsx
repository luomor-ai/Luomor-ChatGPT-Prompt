...
const TITLE = translate({
  message:
    "Luomor ChatGPT Prompt - 简单易用的 ChatGPT 快捷指令表，让生产力倍增！标签筛选、关键词搜索和一键复制 Prompts",
});
const DESCRIPTION = translate({
  message: "让生产力加倍的 ChatGPT 快捷指令",
});
const SUBMIT_URL =
  "https://github.com/luomor-ai/Luomor-ChatGPT-Prompt/discussions/2";
...
function ShowcaseHeader() {
  return (
    <section className="margin-top--lg margin-bottom--lg text--center">
      <Heading as="h1">Luomor ChatGPT Prompt</Heading>
      <p>{DESCRIPTION}</p>
